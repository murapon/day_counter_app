...
class ApiClient {
  ApiClient({this.basePath = 'http://localhost:31180'}) {
  }
    ...
    try {
      switch (targetType) {
        ...
        case 'ResponseEventsGetList':
          return ResponseEventsGetList.fromJson(value);
        case 'ResponseJwtKeyPost':
          return ResponseJwtKeyPost.fromJson(value);
        case 'ResponseUserPost':
          return ResponseUserPost.fromJson(value);
        default:
          Match match;
